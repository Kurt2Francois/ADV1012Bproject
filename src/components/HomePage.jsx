...
const HomePage = () => {
  ...
  // Example slides data
  const slides = [
    { url: "http://localhost:5175/image1.jpg", title: "beach" },
    { url: "http://localhost:5175/image2.jpg", title: "boat" },
    { url: "http://localhost:5175/image3.jpg", title: "forest" },
    { url: "http://localhost:5175/image4.jpg", title: "city" },
    { url: "http://localhost:5175/image5.jpg", title: "italy" },
  ];
